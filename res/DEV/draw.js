		...
		$.ajax({
			...
			success:function(data){
				...
				for(i;i<len;i++){
					...
					if(data.drawList[i].lotteryId==10059){
						html.push('<div class="playType"><a href="footBallDraw.html#lottery='+data.drawList[i].lotteryId+'/">');
					}else{
						html.push('<div class="playType"><a href="historyList.html#lottery='+data.drawList[i].lotteryId+'/">');
					}
		...
		$.ajax({
			...
			success:function(data){
				...
				for(i;i<len;i++){
					...
					html.push('<div class="playType"><div class="drawList"><a href="drawDetail.html#lottery='+id+'&issue='+data.list[i].issue+'/">');
	...
	detail:function(id,issue){
		$.ajax({
			...
			success:function(data){
				...
				html.push('<a class="fixBottom" href="buySZC.html#lottery='+data.lotteryId+'&type=a0">购买'+data.lotteryName+'</a>');
				}
				dom.c.html(html.join(''));
			},
			error:function(){cp2y.dialog.clearLoading();}
