...
cp2y.buy={
	...
	submit:function(){
		cp2y.dialog.closeConfirm();
		this.saleType=0;
		var getBets=this.getBets(),issueIds=[],i=0,len=getBets.length,issueCount=0,multiple=[],burstIntoStop=this.burstIntoStop,prizeStop=this.prizeStop,schemeNumber={},schemeNumbers='',money=dom.Money.html();
		for(i in cp2y.buy.issues){
			issueCount++;
			issueIds.push(i);
