var _={
	bt:10061,playName:"新时时彩",playTypes:function(){
		var html=[];
...
_.a0={
	playName:_.playName,playType:"一星",input:"oneStar",num:1,bet:function(){
		var html0=[],i=0;
...
_.a1={
	playName:_.playName,playType:"四星",input:"fourStarPoly",num:4,bet:function(){
		var html0=[],i=0;
		html0.push('<p>千位</p>');
		for(i;i<10;i++){
...
_.a2={
	playName:_.playName,playType:"五星",input:"fiveStarPoly",num:5,bet:function(){
		var html0=[],i=0;
		html0.push('<p>万位</p>');
		for(i;i<10;i++){
...
_.a3={
	playName:_.playName,playType:"五星通选",input:"fiveStarAllPoly",num:5,bet:_.a2.bet,select:_.a2.select,count:_.a2.count,random:_.a2.random,addContent:_.a2.addContent
};
_.a4={
	playName:_.playName,playType:"二星组选",input:"twoStarGroupPoly",num:2,bet:_.a0.bet,select:_.a0.select,count:function(){
		var rb=[],i=0,o=this.getBall(),len=o.length,units,s=1;
		for(i;i<len;i++){
			if(o.eq(i).hasClass("rb")){
				rb.push(o.eq(i))
	...
	,random:_.a0.random,addContent:_.a0.addContent
};
_.a5={
	playName:_.playName,playType:"三星组3",input:"threeStarGroup3Poly",num:2,bet:_.a0.bet,select:_.a0.select,count:function(){
		var rb=[],i=0,o=this.getBall(),len=o.length,units,s=1;
		for(i;i<len;i++){
			if(o.eq(i).hasClass("rb")){
				rb.push(o.eq(i))
...
_.a6={
	playName:_.playName,playType:"三星组6",input:"threeStarGroup6Poly",num:3,bet:_.a0.bet,select:_.a0.select,count:function(){
		var rb=[],i=0,o=this.getBall(),len=o.length,units,s=1;
		for(i;i<len;i++){
			if(o.eq(i).hasClass("rb")){
				rb.push(o.eq(i))
	...
	,random:_.a0.random,addContent:function(){
		var rb=[],i=0,o=this.getBall(),len=o.length;
		for(i;i<len;i++){
			if(o.eq(i).hasClass("rb")){
				rb.push(o.eq(i).html())
...
_.a7={
	playName:_.playName,playType:"任选1",input:"renOne",num:1,bet:_.a2.bet,select:_.a2.select,count:function(){
		var rb1=[],rb2=[],rb3=[],rb4=[],rb5=[],i=0,o=this.getBall(),len=o.length,units,s=1;
		for(i;i<len;i++){
			if(o.eq(i).hasClass("rb1")){
				rb1.push(o.eq(i))
...
_.a8={
	playName:_.playName,playType:"任选2",input:"renTwo",num:2,bet:_.a7.bet,select:_.a7.select,combi:function(arr,num){
		var r=[];
		(function f(t,a,n){
...
_.a9={
	playName:_.playName,playType:"大小单双",input:"dxds",num:2,bet:function(){
		var html0=[],i=0;
		html0.push('<p></p>');
...
_.a10={
	playName:_.playName,playType:"二星直选",input:"twoStarDirectPoly",num:2,bet:function(){
		var html0=[],i=0;
		html0.push('<p>十位</p>');
		for(i;i<10;i++){
			html0.push('<a class="gb" onclick="cp2y.buy.select(this,2)">'+i+'</a>')
	...
	,select:_.a2.select,count:function(){
	...
	,random:_.a2.random,addContent:function(){
...
_.a11={
	playName:_.playName,playType:"三星直选",input:"threeStarDirectPoly",num:3,bet:function(){
		var html0=[],i=0;
		html0.push('<p>百位</p>');
		for(i;i<10;i++){
			html0.push('<a class="gb" onclick="cp2y.buy.select(this,3)">'+i+'</a>')
