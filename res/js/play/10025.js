var _={
	bt:10025,playName:"福彩3D",playTypes:function(){
		var html=[];
		html.push('<i>普通</i>');
...
_.a0={
	playName:_.playName,playType:"普通-直选",input:"direct",bet:function(){
		var html0=[],i=0;
		html0.push('<p>百位</p>');
		for(i;i<10;i++){
...
_.a1={
	playName:_.playName,playType:"普通-组三",input:"group3Poly",bet:function(){
		var html0=[],i=0;
